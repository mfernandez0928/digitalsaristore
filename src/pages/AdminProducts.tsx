...
export default function AdminProducts() {
  ...
  const [supabaseStatus, setSupabaseStatus] = useState<
    "checking" | "connected" | "error" | "not-configured"
  >("checking");
  ...
  useEffect(() => {
    ...
    const checkSupabase = async () => {
      try {
        ...
        if (!result.success) {
          setSupabaseError(
            result.error || "Could not connect to Supabase storage.",
          );
        }
      } catch (err: any) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (selectedFile) {
        const uploadResult =
          await supabaseService.uploadProductImage(selectedFile);
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm opacity-90 leading-relaxed mt-1">
                  {supabaseError ||
                    "The app cannot reach Supabase storage. Please check your VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in the Secrets panel."}
                </p>
              </div>
              <button
                onClick={async () => {
            ...
            <div className="bg-white/50 p-4 rounded-2xl border border-red-100/50">
              ...
              <ul className="text-xs space-y-2 list-disc pl-4 opacity-80 font-medium">
                ...
                <li>
                  Ensure <b>VITE_SUPABASE_URL</b> starts with{" "}
                  <code className="bg-red-100 px-1 rounded">https://</code>.
                </li>
                <li>
                  Ensure <b>VITE_SUPABASE_ANON_KEY</b> starts with{" "}
                  <code className="bg-red-100 px-1 rounded">eyJ</code> (JWT
                  format).
                </li>
                <li>
                  In Supabase: Go to <b>Project Settings</b> → <b>API</b> → Copy
                  the <b>anon public</b> key.
                </li>
                <li className="mt-4 pt-4 border-t border-red-200/50">
                  ...
                  <p className="mb-2">
                    Run this in your Supabase <b>SQL Editor</b> to allow public
                    uploads:
                  </p>
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  <h3 className="font-black text-slate-900 truncate text-base">
                    {product.name}
                  </h3>
            ...
            >
              <div className="flex flex-col gap-2 text-center">
                ...
                <p className="text-slate-500 text-sm leading-relaxed font-medium">
                  Your Supabase storage bucket is locked. You need to run a SQL
                  command in your Supabase dashboard to allow image uploads.
                </p>
              </div>
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="w-12 h-12 bg-slate-50 text-slate-400 rounded-full flex items-center justify-center active:scale-90 transition-transform"
                >
                  ✕
                </button>
              </div>
              ...
              <form
                ...
                className="flex flex-col gap-6 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar"
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  />
                  {uploadError && (
                    <p className="text-[10px] font-black text-red-500 ml-1">
                      {uploadError}
                    </p>
                  )}
                </div>
