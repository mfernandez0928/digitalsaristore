...
export function AuthProvider({ children }: { children: React.ReactNode }) {
      ...
      if (user && db) {
        try {
          ...
          if (settingsDoc.exists()) {
            ...
            setIsAdmin(user.email === data.adminEmail || user.email === 'triosstore26@gmail.com');
          } else {
  ...
  return (
    <AuthContext.Provider value={{ user, loading, isAdmin, storeSettings, userData, updateSettings, updateUserProfile, logout }}>
      {children}
